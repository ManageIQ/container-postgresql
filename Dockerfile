...
RUN if [ $(uname -m) != "s390x" ] ; then yum -y --setopt=tsflags=nodocs install \
    ...
    yum -y install /opt/app-root/src/bin-rpm-dir/postgresql-10.19-1.el8.s390x.rpm  /opt/app-root/src/bin-rpm-dir/postgresql-contrib-10.19-1.el8.s390x.rpm  /opt/app-root/src/bin-rpm-dir/postgresql-server-10.19-1.el8.s390x.rpm && \
